...
// #define X_STEP_WRITE(STATE) WRITE_VAR(X_STEP_PIN,STATE)
#define X_STEP_READ READ(X_STEP_PIN)

#define X_DIR_INIT SET_OUTPUT(X_DIR_PIN)
#define X_DIR_WRITE(STATE) WRITE(X_DIR_PIN,STATE)
// #define X_DIR_WRITE(STATE) WRITE_VAR(X_DIR_PIN,STATE)
#define X_DIR_READ READ(X_DIR_PIN)

#define X_ENABLE_INIT SET_OUTPUT(X_ENABLE_PIN)
#define X_ENABLE_WRITE(STATE) WRITE(X_ENABLE_PIN,STATE)
// #define X_ENABLE_WRITE(STATE) WRITE_VAR(X_ENABLE_PIN,STATE)
#define X_ENABLE_READ READ(X_ENABLE_PIN)

// XX motor
#define XX_STEP_INIT SET_OUTPUT(XX_STEP_PIN)
#define XX_STEP_WRITE(STATE) WRITE(XX_STEP_PIN,STATE)
// #define XX_STEP_WRITE(STATE) WRITE_VAR(XX_STEP_PIN,STATE)
...
// #define XX_DIR_WRITE(STATE) WRITE_VAR(XX_DIR_PIN,STATE)
...
// #define XX_ENABLE_WRITE(STATE) WRITE_VAR(XX_ENABLE_PIN,STATE)
...
// #define Y_STEP_WRITE(STATE) WRITE_VAR(Y_STEP_PIN,STATE)
#define Y_STEP_READ READ(Y_STEP_PIN)

#define Y_DIR_INIT SET_OUTPUT(Y_DIR_PIN)
#define Y_DIR_WRITE(STATE) WRITE(Y_DIR_PIN,STATE)
// #define Y_DIR_WRITE(STATE) WRITE_VAR(Y_DIR_PIN,STATE)
#define Y_DIR_READ READ(Y_DIR_PIN)

#define Y_ENABLE_INIT SET_OUTPUT(Y_ENABLE_PIN)
#define Y_ENABLE_WRITE(STATE) WRITE(Y_ENABLE_PIN,STATE)
// #define Y_ENABLE_WRITE(STATE) WRITE_VAR(Y_ENABLE_PIN,STATE)
...
// #define YY_STEP_WRITE(STATE) WRITE_VAR(YY_STEP_PIN,STATE)
...
// #define YY_DIR_WRITE(STATE) WRITE_VAR(YY_DIR_PIN,STATE)
...
// #define YY_ENABLE_WRITE(STATE) WRITE_VAR(YY_ENABLE_PIN,STATE)
#define YY_ENABLE_READ READ(YY_ENABLE_PIN)

// Y2 motor
#define Y2_STEP_INIT SET_OUTPUT(Y2_STEP_PIN)
#define Y2_STEP_WRITE(STATE) WRITE(Y2_STEP_PIN,STATE)
// #define Y2_STEP_WRITE(STATE) WRITE_VAR(Y2_STEP_PIN,STATE)
#define Y2_STEP_READ READ(Y2_STEP_PIN)

#define Y2_DIR_INIT SET_OUTPUT(Y2_DIR_PIN)
#define Y2_DIR_WRITE(STATE) WRITE(Y2_DIR_PIN,STATE)
// #define Y2_DIR_WRITE(STATE) WRITE_VAR(Y2_DIR_PIN,STATE)
#define Y2_DIR_READ READ(Y2_DIR_PIN)

#define Y2_ENABLE_INIT SET_OUTPUT(Y2_ENABLE_PIN)
#define Y2_ENABLE_WRITE(STATE) WRITE(Y2_ENABLE_PIN,STATE)
// #define Y2_ENABLE_WRITE(STATE) WRITE_VAR(Y2_ENABLE_PIN,STATE)
#define Y2_ENABLE_READ READ(Y2_ENABLE_PIN)

// Z motor
#define Z_STEP_INIT SET_OUTPUT(Z_STEP_PIN)
#define Z_STEP_WRITE(STATE) WRITE(Z_STEP_PIN,STATE)
// #define Z_STEP_WRITE(STATE) WRITE_VAR(Z_STEP_PIN,STATE)
#define Z_STEP_READ READ(Z_STEP_PIN)

#define Z_DIR_INIT SET_OUTPUT(Z_DIR_PIN)
#define Z_DIR_WRITE(STATE) WRITE(Z_DIR_PIN,STATE)
// #define Z_DIR_WRITE(STATE) WRITE_VAR(Z_DIR_PIN,STATE)
#define Z_DIR_READ READ(Z_DIR_PIN)

#define Z_ENABLE_INIT SET_OUTPUT(Z_ENABLE_PIN)
#define Z_ENABLE_WRITE(STATE) WRITE(Z_ENABLE_PIN,STATE)
// #define Z_ENABLE_WRITE(STATE) WRITE_VAR(Z_ENABLE_PIN,STATE)
#define Z_ENABLE_READ READ(Z_ENABLE_PIN)

// ZZ motor
#define ZZ_STEP_INIT SET_OUTPUT(ZZ_STEP_PIN)
#define ZZ_STEP_WRITE(STATE) WRITE(ZZ_STEP_PIN,STATE)
// #define ZZ_STEP_WRITE(STATE) WRITE_VAR(ZZ_STEP_PIN,STATE)
...
// #define ZZ_DIR_WRITE(STATE) WRITE_VAR(ZZ_DIR_PIN,STATE)
...
// #define ZZ_ENABLE_WRITE(STATE) WRITE_VAR(ZZ_ENABLE_PIN,STATE)
#define ZZ_ENABLE_READ READ(ZZ_ENABLE_PIN)

// Z2 motor
#define Z2_STEP_INIT SET_OUTPUT(Z2_STEPPIN)
...
#define C1_STEP_INIT SET_OUTPUT(C1_STEP_PIN)
#define C1_STEP_WRITE(STATE) WRITE(C1_STEP_PIN,STATE)
#define C1_STEP_READ READ(C1_STEP_PIN)

#define C1_DIR_INIT SET_OUTPUT(C1_DIR_PIN)
#define C1_DIR_WRITE(STATE) WRITE(C1_DIR_PIN,STATE)
#define C1_DIR_READ READ(C1_DIR_PIN)

//Chip mounter No.2 axis
#define C2_STEP_INIT SET_OUTPUT(C2_STEP_PIN)
#define C2_STEP_WRITE(STATE) WRITE(C2_STEP_PIN,STATE)
#define C2_STEP_READ READ(C2_STEP_PIN)

#define C2_DIR_INIT SET_OUTPUT(C2_DIR_PIN)
#define C2_DIR_WRITE(STATE) WRITE(C2_DIR_PIN,STATE)
#define C2_DIR_READ READ(C2_DIR_PIN)

//Chip mounter No.3 axis
#define C3_STEP_INIT SET_OUTPUT(C3_STEP_PIN)
#define C3_STEP_WRITE(STATE) WRITE(C3_STEP_PIN,STATE)
#define C3_STEP_READ READ(C3_STEP_PIN)

#define C3_DIR_INIT SET_OUTPUT(C3_DIR_PIN)
#define C3_DIR_WRITE(STATE) WRITE(C3_DIR_PIN,STATE)
#define C3_DIR_READ READ(C3_DIR_PIN)
