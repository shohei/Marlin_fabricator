 ...
 */
  ...
  #define HAS_C1_DIR (PIN_EXISTS(C1_DIR))
  #define HAS_C2_DIR (PIN_EXISTS(C2_DIR))
  #define HAS_C3_DIR (PIN_EXISTS(C3_DIR))
  #define HAS_W_DIR (PIN_EXISTS(W_DIR))
  ...
  #define HAS_C1_STEP (PIN_EXISTS(C1_STEP))
  #define HAS_C2_STEP (PIN_EXISTS(C2_STEP))
  #define HAS_C3_STEP (PIN_EXISTS(C3_STEP))
  #define HAS_W_STEP (PIN_EXISTS(W_STEP))
