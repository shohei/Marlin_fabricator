...
#define DEFAULT_MAX_FEEDRATE          {30000, 30000, 30000, 20000}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,9000,9000,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
